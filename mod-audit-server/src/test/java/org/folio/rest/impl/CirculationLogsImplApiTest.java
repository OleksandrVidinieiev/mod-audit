...
public class CirculationLogsImplApiTest extends ApiTestBase {
  ...
  void getCirculationAuditLogRecordsFilterByAction() {
    ...
    assertThat(groupedByObjectRecords.get(LogRecord.Object.ITEM_BLOCK).get(0).getAction(), equalTo(
      Action.CREATED));

    assertThat(groupedByObjectRecords.get(LogRecord.Object.REQUEST), hasSize(2));
    assertThat(groupedByObjectRecords.get(LogRecord.Object.REQUEST).get(0).getAction(), equalTo(
      Action.CREATED));
